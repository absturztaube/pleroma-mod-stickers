...
PleromaStickers.prototype.getStickers = function(pack) {
    ...
    xmlhttp.open('GET', window.__pleromaModLoader.config.modDirectory + 'pleroma-mod-stickers/' + self.config.stickersDir + pack + '/productInfo.meta', true);
    xmlhttp.send();
};
...
PleromaModStickers.prototype.run = function() {
    ...
    stylesheet.setAttribute('href', window.__pleromaModLoader.config.modDirectory + 'pleroma-mod-stickers/' + self.config.stylesheet);
